  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-xl font-semibold text-foreground">Preventive Maintenance Calendar</h3>
        ...
        <div className="grid grid-cols-7 gap-2">
          ...
          {days.map((day) => {
            ...
            return (
              ...
              >
                <div className="font-semibold text-sm text-foreground mb-1">{day}</div>
      ...
      <div className="space-y-4">
        <h4 className="font-semibold text-foreground">Upcoming Scheduled Maintenance</h4>
        {mockEvents.map((event) => (
          <Card key={event.date} className="p-4">
            <div className="flex items-start justify-between mb-3">
              <div>
                <h5 className="font-semibold text-foreground">{event.date}</h5>
